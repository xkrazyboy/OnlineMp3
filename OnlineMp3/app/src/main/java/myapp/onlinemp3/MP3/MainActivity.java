...
import myapp.onlinemp3.Adapter.AdapterNavigation;
import myapp.onlinemp3.AsyncTask.GetRating;
import myapp.onlinemp3.AsyncTask.LoadAbout;
import myapp.onlinemp3.AsyncTask.LoadRating;
import myapp.onlinemp3.Interfaces.AboutListener;
import myapp.onlinemp3.Interfaces.AdConsentListener;
import myapp.onlinemp3.Interfaces.RatingListener;
import myapp.onlinemp3.Interfaces.RecyclerClickListener;
import myapp.onlinemp3.Item.ItemAbout;
import myapp.onlinemp3.Item.ItemSong;
import myapp.onlinemp3.R;
import myapp.onlinemp3.Utils.AdConsent;
import myapp.onlinemp3.Utils.Constant;
import myapp.onlinemp3.Utils.DBHelper;
import myapp.onlinemp3.Utils.JsonUtils;
import myapp.onlinemp3.Utils.PausableRotateAnimation;
import myapp.onlinemp3.Utils.SharedPref;
import myapp.onlinemp3.Utils.ZProgressHUD;
...
//        audio_progress.setOnValueChangedListener(this);
    ...
    private void shareSong() {
        if (Constant.arrayList_play.size() > 0) {
            ...
            sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "Tôi đang nghe bài hát:" + " " + Constant.arrayList_play.get(viewpager.getCurrentItem()).getMp3Name() + "\n\n " + getResources().getString(R.string.app_name)+"tại" + " - http://play.google.com/store/apps/details?id=" + getPackageName());
